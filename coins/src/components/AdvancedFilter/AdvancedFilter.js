                ...
                <div className="selects">
                    ...
                    <div className="select-box">
                        <label htmlFor="metal">Metal</label>
                            <select value={this.state.metal} name="metal" id="metal" onChange={this.valueChange}>
                                <option value="all">All</option>
                    ...
                    <div className="select-box">
                        <label htmlFor="quality">Quality of the coin</label>
                            <select value={this.state.quality} name="quality" id="quality" onChange={this.valueChange}>
                        ...
                        <div className="inputs-box">
                            <div className="input-box">
                                <label htmlFor="price-from">from</label>
                                    <input value={this.state.priceFrom} type="number" name="price-from" id="price-from" onChange={this.valueChange} />
                            </div>
                            <div className="input-box">
                                <label htmlFor="price-to" className="to">to</label>
                                    <input value={this.state.priceTo} type="number" name="price-to" id="price-to" onChange={this.valueChange} />
                            </div>
                        </div>
                    </div>
                    <div className="inputs-container">
                        ...
                        <div className="inputs-box">
                            <div className="input-box">
                                <label htmlFor="year-from">from</label>
                                    <input value={this.state.yearFrom} type="number" name="year-from" id="year-from" onChange={this.valueChange} />
                            </div>
                            <div className="input-box">
                                <label htmlFor="year-to" className="to">to</label>
                                    <input value={this.state.yearTo} type="number" name="year-to" id="year-to" onChange={this.valueChange} />
                            </div>
                        </div>
                    </div>
                </div>
